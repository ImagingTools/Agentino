...
class AgentinoConan(ConanFile):
    ...
    description = "Agentino is a distributed service management system"
    url = "https://github.com/ImagingTools/Agentino"
    ...
    def package(self):
        ...
        copy(self, "*.pdb",
             ...
             keep_path=False)
        cp(["*.exe", "*.dll", "*.pdb", "*.arp", "*Agentino*"], "Bin")
