...
#include <agentgql/CUpdateCollectionControllerComp.h>
...
bool CUpdateCollectionControllerComp::CreateRepresentationFromObject(
			...
			QString& errorMessage) const
{
	...
	const agentinodata::IUpdateInfo* updateInfoPtr = dynamic_cast<const agentinodata::IUpdateInfo*>(dataPtr.GetPtr());
...
bool CUpdateCollectionControllerComp::CreateRepresentationFromObject(
			...
			QString& errorMessage) const
{
	const agentinodata::IUpdateInfo* updateInfoPtr = dynamic_cast<const agentinodata::IUpdateInfo*>(&data);
	if (updateInfoPtr == nullptr){
		errorMessage = "Invalid update info object";
		return false;
	}
